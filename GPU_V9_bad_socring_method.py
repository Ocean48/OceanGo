...
class Config:
    ...
    ## CHANGELOG: Increased games per iteration to fill the larger replay buffer faster.
    ...
    ## CHANGELOG: Slightly reduced c_puct to favor exploitation once good moves are found.
    mcts_c_puct: float = 1.25             # Exploration factor in PUCT.
    ## CHANGELOG: Significantly increased dirichlet noise to force more exploration.
    dirichlet_alpha: float = 0.1          # Noise for root node exploration.
    start_temp: float = 1.0               # Initial temperature for move selection.
    ## CHANGELOG: Extended the temperature decay phase to encourage more mid-game exploration.
    ...
    ## CHANGELOG: Increased replay buffer size for greater strategic memory.
    replay_cap: int = 60_000   # Maximum positions kept.
    ## CHANGELOG: Increased sample size to learn from a more diverse data pool.
