...
## CHANGELOG: New function to resolve life & death with a policy-guided playout.
@torch.no_grad()
def _policy_guided_playout(game: GoGame, net: PolicyValueNet):
    ...
    for _ in range(CFG.cleanup_moves):
        ...
        ## CHANGELOG: CRITICAL BUG FIX - Convert BFloat16 tensor to Float32 before sending to CPU/NumPy.
